...
import top.iserv.ylpay.models.MerchantCloudPayInfo;

public class MerchantScanResponse extends AbstractResponse {
    // 第三方业务码
    ...
    // 支付参数
    private MerchantCloudPayInfo cloudPayInfo;
    ...
    public MerchantCloudPayInfo getCloudPayInfo() {
        return cloudPayInfo;
    }

    public void setCloudPayInfo(MerchantCloudPayInfo cloudPayInfo) {
        this.cloudPayInfo = cloudPayInfo;
    }

    @Override
    public String toString() {
        return "MerchantScanResponse{" +
                "thirdCode='" + thirdCode + '\'' +
                ", mchid='" + mchid + '\'' +
